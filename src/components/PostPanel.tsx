  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Header */}
        <div style={{ display: 'flex', alignItems: 'center', padding: '14px 20px', borderBottom: '1px solid var(--bd)', position: 'sticky', top: 0, background: 'var(--bg)', zIndex: 1 }}>
          <button onClick={onClose} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--t3)', display: 'flex', alignItems: 'center', gap: 6, fontSize: '.8rem', fontWeight: 600 }}>
            <svg width="16" height="16" fill="none" viewBox="0 0 16 16"><path d="M10 13l-5-5 5-5" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/></svg>
            Close
          </button>
        </div>
        ...
        <div style={{ padding: '20px' }}>
          {/* Post */}
          <div style={{ background: 'var(--sur)', border: '1px solid var(--bd)', borderRadius: 'var(--rm)', padding: '18px', marginBottom: 14 }}>
            ...
            <div style={{ display: 'flex', gap: 6, paddingTop: 12, borderTop: '1px solid var(--bd)', alignItems: 'center' }}>
              ...
              <span style={{ fontSize: '.75rem', color: 'var(--t4)' }}>{post.reply_count} replies</span>
          ...
          {/* Reply composer */}
          {user && (
            <div style={{ background: 'var(--sur)', border: '1px solid var(--bd)', borderRadius: 'var(--rm)', padding: '14px', marginBottom: 14 }}>
              <textarea
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', paddingTop: 8, borderTop: '1px solid var(--bd)' }}>
                <button onClick={submitReply} disabled={!body.trim() || loading} style={{ fontSize: '.8rem', fontWeight: 600, padding: '7px 16px', borderRadius: 'var(--r)', background: body.trim() ? '#18181B' : '#D4D4D8', color: '#fff', border: 'none', cursor: 'pointer', fontFamily: 'inherit' }}>
